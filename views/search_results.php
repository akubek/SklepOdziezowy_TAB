<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="text-break m-0">
        Wyniki dla: <span class="text-primary">"<?= e($searchQuery) ?>"</span>
    </h1>
    <div class="d-flex align-items-center gap-3">
        <select class="form-select form-select-sm" id="sort-select" style="width: auto;">
            <option value="newest" <?= ($sort ?? 'newest') === 'newest' ? 'selected' : '' ?>>Najnowsze</option>
        ...
        <span class="text-muted text-nowrap">Znaleziono: <?= count($products) ?></span>
    </div>
</div>
